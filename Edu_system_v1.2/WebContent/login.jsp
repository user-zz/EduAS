...
<body>
	...
	<div align="center">
		...
		<form action="Login" method="post"  onSubmit="return isCheckUserNull();">
			<div align="center">
		    ...
		    <div align="center" >
			    <table>
			    	<tr>
			    		<td align="left">
			    			<font size="1px" color="#A9A9A9">温馨提示：没有账号？请先</font><a href="regist.jsp" target="_blank"><font size="1px" color="#4169E1">注册。</font></a>
			    		</td>
			    	</tr>
			    </table>
		    </div>
