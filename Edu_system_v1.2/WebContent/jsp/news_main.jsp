...
<style type="text/css">
	...
	<%
			try{
				...
				//获取总记录数
				ResultSet rs = statement.executeQuery("SELECT count(*) from th_table WHERE Thpass='T'");
				rs.next();
				RecordCount = rs.getInt(1);
			
				rs = statement.executeQuery("SELECT Title,Thusername,Thcontent,Thtime,Thclickrate,Thtype,Thno FROM th_table WHERE Thpass='T' LIMIT "+StartRow+", "+PageSize);
