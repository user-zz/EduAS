...
<body bgcolor="#FAEBD7" onload="setMessage()">
<br>
	<div align="center">
	...
	<c:if test="${not empty tempuserlist}">
			 ...
			 <div align="center">
				<table width="95%">
					...
					<c:forEach items="${tempuserlist}" var="tempuserbean">
						<tr>
							<td align="center" valign="middle"  bordercolor="#000000"><span class="STYLE13">${tempuserbean.tempusername}</span></td>
							<td align="center" valign="middle"  bordercolor="#000000"><span class="STYLE13">${tempuserbean.temprealname}</span></td>
							...
							<td align="center"  valign="middle" bordercolor="#000000">
								<a href="<%=request.getContextPath()%>/ChangeId?op=givepower&Username=${tempuserbean.tempusername}">授权管理员</a>&nbsp;&nbsp;
								<a href="<%=request.getContextPath()%>/ChangeId?op=removepower&Username=${tempuserbean.tempusername}">移除管理员</a>
							</td>
						</tr>
					</c:forEach>
				</table>
