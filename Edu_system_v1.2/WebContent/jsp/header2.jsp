...
<body >
	<div>
		...
		<div align="center" class="header_navigation_style" >
			...
			<span><a href="news.jsp" target="_top">&nbsp;&nbsp;最新资讯&nbsp;&nbsp;|</a></span>
			<span><a href="learnMtrl.jsp" target="_top" >&nbsp;&nbsp;学习资料&nbsp;&nbsp;|</a></span>
			<span><a href="chat.jsp"  target="_top">&nbsp;&nbsp;互动大厅&nbsp;&nbsp;|</a></span>
			<span><a href="userCenter.jsp" target="_top">&nbsp;&nbsp;个人中心&nbsp;&nbsp;|</a></span>
			<span><a href="../login.jsp" target="_top">&nbsp;&nbsp;登录&nbsp;|&nbsp;</a><a href="../regist.jsp"  target="_blank">注册</a></span>
			<span><a href="logout.jsp" target="_top">|&nbsp;&nbsp;注销</a></span>
		</div>
	</div>
	<br/>
</body>
