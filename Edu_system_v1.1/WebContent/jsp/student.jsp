...
<frameset rows="200,*" cols="*" frameborder="no" border="0" framespacing="0">
      ...
      <frameset cols="220,*" frameborder="no" border="0" framespacing="0" >
        <frame src="<%=basePath %>jsp/stu_left.jsp" name="stu_leftFrame" noresize="noresize" scrolling="no" frameborder="0"   id="stu_leftFrame"/>
        <frame src="<%=basePath %>jsp/stu_main.jsp" name="stu_mainFrame" scrolling="auto" id="stu_mainFrame"/>
      </frameset>
</frameset>
