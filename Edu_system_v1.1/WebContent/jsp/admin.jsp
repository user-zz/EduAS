...
<frameset rows="200,*" cols="*" frameborder="no" border="0" framespacing="0">
      ...
      <frameset cols="220,*" frameborder="no" border="0" framespacing="0" >
        <frame src="<%=basePath %>jsp/admin_left.jsp" name="admin_leftFrame" noresize="noresize" scrolling="no" frameborder="0"   id="admin_leftFrame"/>
        <frame src="<%=basePath %>jsp/admin_main.jsp" name="admin_mainFrame" scrolling="auto" id="admin_mainFrame"/>
      </frameset>
</frameset>
